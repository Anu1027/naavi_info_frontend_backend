...
const NewStep1 = ({ step, setStep, setMainMenu, loading, setLoading }) => {
  ...
  const getContent = () => {
            ...
            <div
              ...
              style={{
                height: pathname?.includes("/dashboard/accountants")
                  ? "calc(100% - 8rem)"
                  : "",
                padding: pathname?.includes("/dashboard/accountants")
                  ? "0"
                  : "",
              }}
            >
              ...
              >
                ...
                >
                  <label className="fileInp icon" style={{ marginTop: "0" }}>
                    <img
    ...
    ></label> */}
            ...
            {/* <div className="footerBtns"> */}
            <div className="NextBtn">Submit Step</div>
            {/* <div
                                className="newField"
