...
const NewStep = ({ step, setStep, setMainMenu, loading, setLoading }) => {
                    ...
                    <>
                        <div className="newConglomerate">
                            ...
                            >
                                ...
                                {/* Select Author */}
                                <div className="name">What country will this step take place in?</div>
                                {author?._id ? (
                                    <div
                                        className="user"
                                        onClick={authorStep}
                                ...
                                <textarea type="text" class="text-textarea" placeholder="Description..." rows="5" cols="40" spellcheck="false"></textarea>

                                {/* Upload Logos */}
                                <div className="name" onClick={() => setSelectBtn(!selectBtn)}>Upload a icon
    ...
    ></label> */}
                                ...
                                <div className="name">What is the costing structure of the step?</div>
                                {author?._id ? (
                                    <div
                                        className="user"
                                        onClick={authorStep}
